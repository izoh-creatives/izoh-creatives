  ...
  return (
    <div className="w-screen h-100 lg:h-130 flex flex-col justify-end items-start pl-4 pr-8 pb-1.5 lg:justify-center lg:pl-8 hero">
      ...
      <div className="w-full flex flex-col items-start space-y-3.5 pb-6 lg:space-y-3 lg:pb-1 lg:mt-24">
        ...
        <Link
          href="#contacts"
          className="w-31 flex justify-between items-center bg-red-600 text-xs rounded-4xl z-1000 px-3.5 py-2 lg:mt-2 group hover:shadow-[0_0_50px] hover:scale-95 hover:shadow-red-600 smooth-animation"
        >
          Get in touch
